...
require_once BROUNHALL_HEADLESS_DIR . 'includes/security/appointment-key-provider.php';
require_once BROUNHALL_HEADLESS_DIR . 'includes/security/appointment-crypto.php';
require_once BROUNHALL_HEADLESS_DIR . 'includes/security/appointment-migration.php';
